...
public class ItemFireStaff_5 extends Wand{
	...
	public void registerIcons(IIconRegister iconRegister){
		this.itemIcon = iconRegister.registerIcon("magica:fire_staff_5");
	}
	...
	public void castSpell(EntityPlayer player) {
		...
		if(!world.isRemote){
			...
			fireball.accelerationX = look.xCoord * 0.3;
			fireball.accelerationY = look.yCoord * 0.3;
			fireball.accelerationZ = look.zCoord * 0.3;
	...
	public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
		par3List.add("Tier 5 - Evo Generation");
		par3List.add("0.25 second cooldown");
	}
}
